...
function etiket(s, t, x, y, renk, w, boy) {
  s.addText(t, { x, y, w: w || 5.4, h: 0.26, fontFace: F, fontSize: boy || 11,
...
function metin(s, t, x, y, o) {
  ...
  s.addText(t, { x, y, w: o.w || 5.0, h: o.h || 0.6, fontFace: F,
    fontSize: o.boy || 11.5, color: o.renk || KURSUN, bold: !!o.kalin,
...
function noElmas(s, cx, cy, n, renk, boy) {
  ...
  s.addText(String(n), { x: cx - 0.35, y: cy - 0.22, w: 0.7, h: 0.44, align: "center",
    valign: "middle", fontFace: F, fontSize: 12, bold: true, color: BEYAZ, margin: 0 });
}
...
baslik(s, "MİA PARK\nOCEAN", M, 2.95, { w: 6.0, h: 2.0, boy: 56, satir: 0.98, aralik: 1 });
cizgi(s, M, 5.10, 1.30, VURGU, 1.5);
metin(s, "İZMİT MİA BÖLGESİ", M, 5.28, { w: 5.0, boy: 13, kalin: true, aralik: 3.0, renk: GECE });
metin(s, "Emlakçılar için yeni bir satış fırsatı", M, 5.66,
  { w: 5.4, boy: 13.5, renk: KURSUN });
blok(s, M, 6.28, 4.30, 0.52, GECE);
metin(s, "21 AĞUSTOS 2026  ·  EMEX OTEL, KOCAELİ", M + 0.24, 6.28,
  { w: 3.95, h: 0.52, boy: 9.5, kalin: true, aralik: 1.4, renk: VURGU_A, dikeyH: "middle" });
s.addImage({ path: sk("ocean-logo-renkli"), x: 5.55, y: 6.30, w: 1.15, h: 0.48 });
...
metin(s, "2026", 5.35, 0.72, { w: 1.30, h: 0.52, boy: 14, kalin: true, hiza: "center",
  dikeyH: "middle", renk: BEYAZ, aralik: 1.5 });
etiket(s, "GÜNDEM", 6.85, 0.86, VURGU);
baslik(s, "BUGÜN NELER\nKONUŞACAĞIZ?", 6.85, 1.22, { w: 5.6, h: 1.5, boy: 32, renk: KAGIT });
[["Proje Özeti", "01"], ["Konum ve MİA Bölgesi", "02"], ["Mimari ve Yaşam", "03"],
 ...
 ["Satış Süreci ve İş Birliği", "07"], ["Güven ve İletişim", "08"]].forEach((g, i) => {
  ...
  metin(s, g[0], 7.55, y, { w: 4.8, h: 0.36, boy: 13, kalin: true, renk: KAGIT, dikeyH: "middle" });
});
...
baslik(s, "MİA PARK OCEAN NEDİR?", M, 1.22, { w: 7.4, boy: 32 });
...
[["600", "KONUT", "İzmit MİA Bölgesi'nde tek etapta"],
 ...
 ["%30", "PEŞİNAT", "Kalan tutar 60 aya kadar taksit"]].forEach((k, i) => {
  ...
  metin(s, k[1], x, y + 0.84, { w: 3.1, h: 0.26, boy: 9.5, kalin: true, aralik: 2.0, renk: VURGU });
  metin(s, k[2], x, y + 1.10, { w: 3.1, h: 0.28, boy: 10, renk: KURSUN });
...
metin(s, "MİA PARK OCEAN, İzmit'in gelişen merkezi iş alanında konumlanan; yatırım ve yaşam talebini aynı noktada buluşturan modern konut projesidir.",
  M, 6.28, { w: 6.9, h: 0.6, boy: 11.5, italik: true, renk: KURSUN });
...
baslik(s, "SATILMASI KOLAY BİR ÜRÜN\nNEDEN OLUŞUR?", M, 1.22, { w: 7.2, h: 1.5, boy: 28 });
...
.forEach((k, i) => {
  ...
  metin(s, k[1], M + 0.82, y - 0.02, { w: 5.6, h: 0.30, boy: 13.5, kalin: true, renk: GECE });
  metin(s, k[2], M + 0.82, y + 0.30, { w: 6.2, h: 0.50, boy: 10.5, renk: KURSUN });
});
...
metin(s, "İyi proje yalnızca güzel değildir; doğru müşteriye kolay anlatılabilir.",
  8.20, 6.20, { w: 4.6, h: 0.55, boy: 11, italik: true, hiza: "center", renk: KURSUN });
kunye(s, true);
...
baslik(s, "HER YERE\nDAKİKALAR İÇİNDE", 5.75, 1.22, { w: 6.7, h: 1.5, boy: 28 });
...
[["D100 Karayolu", "1 DK"], ["İzmit Sahili", "2 DK"], ["41 Burada AVM", "3 DK"],
 ...
 ["Symbol AVM", "7 DK"], ["Kocaeli Üniversitesi", "10 DK"]].forEach((d, i) => {
  ...
  metin(s, d[0], 6.18, y, { w: 4.2, h: 0.32, boy: 12, renk: GECE, dikeyH: "middle" });
  metin(s, d[1], 10.60, y, { w: 1.8, h: 0.32, boy: 13, kalin: true, hiza: "right",
...
metin(s, "Günlük yaşam, ulaşım, sağlık, eğitim ve alışveriş birkaç dakikalık erişim alanında.",
  5.75, 6.72, { w: 6.6, h: 0.30, boy: 10, italik: true, renk: KURSUN });
...
baslik(s, "MİA NEDEN\nÖNEMLİ?", M, 1.22, { w: 3.9, h: 1.6, boy: 32, renk: KAGIT });
...
metin(s, "MİA, Merkezi İş Alanı demektir: bir şehrin ofis, ticaret ve hizmet fonksiyonlarının yoğunlaşması için planlanan bölge.",
  M, 3.22, { w: 3.6, h: 1.0, boy: 11.5, renk: SIS, satir: 1.45 });
...
.forEach((k, i) => {
  const y = 1.30 + i * 1.66;
  rakam(s, k[0], 5.95, y, { w: 1.0, h: 0.62, boy: 28, renk: VURGU });
  metin(s, k[1], 7.10, y + 0.06, { w: 4.35, h: 0.34, boy: 15, kalin: true, renk: GECE });
  metin(s, k[2], 7.10, y + 0.46, { w: 4.35, h: 0.60, boy: 11, renk: KURSUN });
  elmasFoto(s, "e-mia" + (i + 1), 12.10, y + 0.42, 1.30);
  if (i < 2) cizgi(s, 5.95, y + 1.30, 5.45, KAGIT_K, 0.75);
});
metin(s, "Bölgesel gelişim bir potansiyeldir; değer artışı taahhüdü değildir.",
  5.95, 6.70, { w: 6.4, h: 0.28, boy: 9.5, italik: true, renk: KURSUN });

/* ═══════════════════════════════ 7 · STRATEJİK AVANTAJ (AKS) */
s = p.addSlide();
s.background = { color: KAGIT };
etiket(s, "PAZAR", M, 0.86);
baslik(s, "İSTANBUL'A YAKIN, İZMİT'İN MERKEZİNDE", M, 1.22, { w: 11.5, boy: 28 });
...
metin(s, "Şehrin gelişen yeni merkezinde konum", M + 0.40, 3.16,
  { w: 4.8, h: 0.8, boy: 16, kalin: true, renk: KAGIT, satir: 1.2 });
...
metin(s, "Anadolu Yakası'na kıyasla erişilebilir bütçeyle konut", 7.28, 3.16,
  { w: 4.8, h: 0.8, boy: 16, kalin: true, renk: GECE, satir: 1.2 });
...
metin(s, "İSTANBUL ANADOLU YAKASI", M - 0.20, AY + 0.32, { w: 2.6, h: 0.3, boy: 9.5,
  kalin: true, renk: GECE, aralik: 1 });
metin(s, "MİA PARK OCEAN · İZMİT", 5.75, AY - 0.66, { w: 2.6, h: 0.3, boy: 10,
  kalin: true, hiza: "center", renk: GECE, aralik: 1 });
metin(s, "SAKARYA", 11.15, AY + 0.32, { w: 1.4, h: 0.3, boy: 9.5, kalin: true,
  hiza: "right", renk: GECE, aralik: 1 });
metin(s, "yaklaşık 1,5 saat", 2.90, AY - 0.40, { w: 2.6, h: 0.26, boy: 10, italik: true,
  hiza: "center", renk: KURSUN });
metin(s, "yaklaşık 35 dakika", 8.60, AY - 0.40, { w: 2.6, h: 0.26, boy: 10, italik: true,
  hiza: "center", renk: KURSUN });
metin(s, "Proje yalnız İzmit'e değil; İstanbul ve Sakarya'dan gelen Marmara yatırımcısına da hitap eder.",
  M, 6.60, { w: 11.5, h: 0.32, boy: 11.5, italik: true, hiza: "center", renk: KURSUN });
...
baslik(s, "MODERN VE\nZAMANSIZ MİMARİ", M, 4.66, { w: 5.4, h: 1.5, boy: 30, renk: BEYAZ });
...
.forEach((o, i) => {
  ...
  metin(s, o, x + 0.30, y, { w: 2.68, h: 0.30, boy: 11, renk: BEYAZ, dikeyH: "middle" });
});
metin(s, "Projedeki su öğeleri peyzaj amaçlı süs havuzu ve su akslarıdır.",
  7.05, 6.44, { w: 5.4, h: 0.26, boy: 9.5, italik: true, renk: SIS });

/* ═══════════════════════════════════════════ 9 · SİTE İÇİNDE YAŞAM */
s = p.addSlide();
s.background = { color: KAGIT };
etiket(s, "SİTE KONSEPTİ", M, 0.86);
baslik(s, "MERKEZİ AVLU ÇEVRESİNDE YAŞAM", M, 1.22, { w: 10.4, boy: 28 });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
["Merkezi avlu", "Süs havuzları ve su aksları", "Geniş peyzaj alanları",
 ...
 "7/24 güvenlik", "Gün ışığı odaklı cepheler"].forEach((o, i) => {
  ...
  metin(s, o, x + 0.32, y, { w: 3.2, h: 0.34, boy: 12, renk: GECE, dikeyH: "middle" });
});
...
metin(s, "Avludaki su SÜS havuzudur — yüzme havuzu diye anlatmayın.",
  M + 0.75, 5.02, { w: 6.2, h: 0.70, boy: 12, kalin: true, renk: VURGU_A, dikeyH: "middle" });
...
baslik(s, "SATIŞIN OMURGASI: 1+0 VE 1+1", M, 1.22, { w: 10.0, boy: 28 });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
...
.forEach((u, i) => {
  ...
  metin(s, u[1], x + 0.62 - 0.5, 5.42 - 0.22, { w: 1.0, h: 0.44, boy: 15, kalin: true,
    hiza: "center", renk: BEYAZ, dikeyH: "middle" });
  metin(s, "ADET", x + 2.45, 5.06, { w: 2.5, h: 0.24, boy: 9, aralik: 2.4, hiza: "right", renk: VURGU_A });
  rakam(s, u[2], x + 2.45, 5.20, { w: 2.5, h: 0.62, boy: 36, renk: KAGIT, hiza: "right" });
  metin(s, u[3], x + 0.30, 5.94, { w: 4.7, h: 0.44, boy: 10, renk: SIS });
});
metin(s, "Projenin ana satış gücü kompakt daire segmentidir.", M, 6.68,
  { w: 11.5, h: 0.30, boy: 11.5, italik: true, hiza: "center", renk: KURSUN });
...
metin(s, "1+0", 4.55, 0.72, { w: 1.55, h: 0.55, boy: 16, kalin: true, hiza: "center",
  dikeyH: "middle", renk: VURGU, aralik: 2 });
etiket(s, "ÜRÜN DETAYI", 6.35, 0.86);
baslik(s, "1+0 — YATIRIMIN\nKOMPAKT YÜZÜ", 6.35, 1.22, { w: 6.1, h: 1.5, boy: 28 });
...
.forEach((k, i) => {
  ...
  metin(s, k[0], 7.02, y - 0.02, { w: 1.95, h: 0.32, boy: 13.5, kalin: true, renk: GECE });
  metin(s, k[1], 9.10, y - 0.02, { w: 3.3, h: 0.64, boy: 10.5, renk: KURSUN });
...
metin(s, "Kompakt daire, geniş kiracı havuzu demektir: kiralama süresi kısalır, boş kalma riski düşer.",
  6.35, 6.62, { w: 6.05, h: 0.5, boy: 10.5, italik: true, renk: KURSUN });
...
metin(s, "1+1", W - 6.10, 0.72, { w: 1.55, h: 0.55, boy: 16, kalin: true, hiza: "center",
  dikeyH: "middle", renk: VURGU, aralik: 2 });
etiket(s, "ÜRÜN DETAYI", M, 0.86);
baslik(s, "1+1 — DENGELİ\nYAŞAM ÜRÜNÜ", M, 1.22, { w: 6.1, h: 1.5, boy: 28 });
cizgi(s, M, 2.78, 1.30, VURGU, 1.5);
...
.forEach((k, i) => {
  ...
  metin(s, k[0], M + 0.67, y - 0.02, { w: 1.95, h: 0.32, boy: 13.5, kalin: true, renk: GECE });
  metin(s, k[1], M + 2.75, y - 0.02, { w: 3.3, h: 0.64, boy: 10.5, renk: KURSUN });
...
metin(s, "1+0'dan taşınan kiracının doğal adresi: site içinde yükselme merdiveni kurar.",
  M, 6.62, { w: 6.05, h: 0.5, boy: 10.5, italik: true, renk: KURSUN });

/* ══════════════════════════════════════════ 13 · MÜŞTERİ PROFİLLERİ */
s = p.addSlide();
s.background = { color: KAGIT };
etiket(s, "HEDEF KİTLE", M, 0.86);
baslik(s, "BU PROJEYİ KİME\nSATABİLİRSİNİZ?", M, 1.22, { w: 7.0, h: 1.5, boy: 28 });
cizgi(s, M, 2.78, 1.30, VURGU, 1.5);
...
.forEach((k, i) => {
  const y = 3.10 + i * 0.74;
  noElmas(s, M + 0.20, y + 0.16, "0" + (i + 1), VURGU, 0.42);
  metin(s, k[0], M + 0.68, y, { w: 3.05, h: 0.34, boy: 13.5, kalin: true, renk: GECE, dikeyH: "middle" });
  metin(s, k[1], M + 3.85, y - 0.03, { w: 3.60, h: 0.40, boy: 10.5, renk: KURSUN, dikeyH: "middle" });
...
metin(s, "Reddedilen kredi başvurusu burada satışa dönüyor.", 8.55, 6.10,
  { w: 4.2, h: 0.55, boy: 11, italik: true, hiza: "center", renk: KURSUN });
kunye(s, true);
...
baslik(s, "ALICININ ÖNÜNDEKİ ENGELİ\nAZALTAN ÖDEME MODELİ", M, 1.22,
  { w: 7.4, h: 1.5, boy: 27, renk: KAGIT });
cizgi(s, M, 2.80, 1.30, VURGU, 1.5);
[["%30", "PEŞİNAT"], ["60 AY", "VADE FARKSIZ"]].forEach((k, i) => {
  const x = M + i * 3.80;
  rakam(s, k[0], x, 3.20, { w: 3.4, h: 1.05, boy: 56, renk: VURGU });
  metin(s, k[1], x, 4.34, { w: 3.4, h: 0.28, boy: 10.5, kalin: true, aralik: 2.6, renk: SIS });
});
blok(s, M, 4.98, 7.45, 0.74, LACI);
metin(s, "BANKA YOK   ·   FAİZ YOK   ·   KEFİL YOK", M, 4.98,
  { w: 7.45, h: 0.74, boy: 17, kalin: true, hiza: "center", dikeyH: "middle",
...
metin(s, "Tasarrufa dayalı finansman yaklaşımı sayesinde konut alımında banka kredisine alternatif bir ödeme modeli sunulur.",
  M, 6.02, { w: 7.3, h: 0.6, boy: 11.5, renk: SIS, satir: 1.4 });
kunye(s, false, 8.6);
...
baslik(s, "BUGÜNKÜ ÖDEME ÖRNEKLERİ", M, 1.22, { w: 9.4, boy: 28 });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
[["1+0", "699.000 TL", "29.900 TL"], ["1+1", "999.000 TL", "39.900 TL"]].forEach((f, i) => {
  ...
  metin(s, f[0], x + 0.28, 2.94, { w: 1.0, h: 0.44, boy: 16, kalin: true, hiza: "center",
    dikeyH: "middle", renk: BEYAZ });
  cizgi(s, x + 1.55, 3.16, 3.35, "2A5B77", 0.75);
  metin(s, "PEŞİNAT", x + 0.42, 3.78, { w: 2.4, h: 0.24, boy: 9.5, aralik: 2.4, renk: SIS });
  metin(s, f[1], x + 0.42, 4.04, { w: 4.4, h: 0.52, boy: 26, kalin: true, renk: KAGIT });
  metin(s, "AYLIK", x + 0.42, 4.72, { w: 2.4, h: 0.24, boy: 9.5, aralik: 2.4, renk: SIS });
  metin(s, f[2], x + 0.42, 4.98, { w: 4.4, h: 0.46, boy: 20, kalin: true, renk: VURGU_A });
});
blok(s, M, 6.06, 11.53, 0.60, KAGIT_K);
metin(s, "60 AY  ·  VADE FARKSIZ", M, 6.06, { w: 11.53, h: 0.60, boy: 15, kalin: true,
...
metin(s, "Fiyatlar ve kampanya koşulları dönemsel olarak değişebilir. Güncel bilgi için satış ofisiyle iletişime geçiniz.",
  M, 6.86, { w: 11.53, h: 0.28, boy: 9, italik: true, hiza: "center", renk: KURSUN });

/* ══════════════════════════════ 16 · MÜŞTERİ SÜRECİ (4 ADIM) */
s = p.addSlide();
s.background = { color: KAGIT };
etiket(s, "MÜŞTERİ SÜRECİ", M, 0.86);
baslik(s, "PEŞİNATTAN TAPUYA DÖRT ADIM", M, 1.22, { w: 10.4, boy: 28 });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
...
.forEach((a, i) => {
  ...
  metin(s, "ADIM 0" + (i + 1), cx - 1.35, 5.02, { w: 2.7, h: 0.24, boy: 9, kalin: true,
    aralik: 2.2, hiza: "center", renk: VURGU });
  metin(s, a[1], cx - 1.35, 5.28, { w: 2.7, h: 0.32, boy: 14, kalin: true,
    hiza: "center", renk: GECE });
  metin(s, a[2], cx - 1.35, 5.64, { w: 2.7, h: 0.85, boy: 10, hiza: "center", renk: KURSUN });
});
metin(s, "Tapu sorusu mutlaka gelir: ferdileşme, inşaat bitiminde.", M, 6.72,
  { w: 11.5, h: 0.28, boy: 10.5, italik: true, hiza: "center", renk: KURSUN });

/* ═══════════════════════════ 17 · SATIŞ ARGÜMANI (60 SANİYE) */
s = p.addSlide();
s.background = { color: GECE };
etiket(s, "SAHA", M, 0.86, VURGU);
baslik(s, "MÜŞTERİYE 60 SANİYEDE NASIL ANLATILIR?", M, 1.22, { w: 11.5, boy: 27, renk: KAGIT });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
...
.forEach((c, i) => {
  ...
  metin(s, "“" + c + "”", M + 0.75, y, { w: 10.6, h: 0.44, boy: 15, italik: true,
...
baslik(s, "MÜŞTERİ SORARSA NE SÖYLEYECEĞİZ?", M, 1.22, { w: 11.0, boy: 28 });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
...
.forEach((q, i) => {
  ...
  metin(s, q[0], M + 0.40, y - 0.04, { w: 3.95, h: 0.70, boy: 13, kalin: true,
    italik: true, renk: GECE, satir: 1.12 });
  metin(s, q[1], M + 4.70, y - 0.02, { w: 6.85, h: 0.80, boy: 10.5, renk: KURSUN });
...
metin(s, "Bilgilendirme amaçlıdır; yasal veya finansal garanti niteliği taşımaz. Belgeler satış ofisinden talep edilebilir.",
  M, 6.72, { w: 11.53, h: 0.28, boy: 9, italik: true, renk: KURSUN });
...
baslik(s, "SATIŞTA EN GÜÇLÜ\nUNSUR: GÜVEN", M, 1.22, { w: 3.9, h: 1.6, boy: 29, renk: KAGIT });
cizgi(s, M, 2.92, 1.30, VURGU, 1.5);
...
[["S.S. Yahya Kaptan Birlik Yapı Kooperatifi", "Projeyi geliştiren yapı kooperatifi"],
 ...
 ["Ocean Gayrimenkul", "Tek yetkili satıcı"]].forEach((g, i) => {
  ...
  metin(s, g[0], 6.35, y - 0.02, { w: 6.1, h: 0.34, boy: 14, kalin: true, renk: GECE });
  metin(s, g[1], 6.35, y + 0.34, { w: 6.1, h: 0.28, boy: 10.5, renk: KURSUN });
...
s.addImage({ path: mk("ticaret-bakanligi-logo.webp"), x: 10.05, y: 6.02, w: 0.48, h: 0.48 });
s.addImage({ path: sk("ocean-logo-renkli"), x: 11.00, y: 6.08, w: 0.86, h: 0.36 });
metin(s, "Belgeler satış ofisinden talep edilebilir.", 5.95, 6.76,
  { w: 6.45, h: 0.26, boy: 9.5, italik: true, renk: KURSUN });

/* ═══════════════════════════ 20 · İŞ BİRLİĞİ SÜRECİ (5 ADIM) */
s = p.addSlide();
s.background = { color: KAGIT };
etiket(s, "İŞ BİRLİĞİ", M, 0.86);
baslik(s, "EMLAKÇIYLA NASIL ÇALIŞIYORUZ?", M, 1.22, { w: 10.4, boy: 28 });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
...
[["i-belge-beyaz", "Kayıt", "Emlakçı kaydı ve yetki belgesi"],
 ...
 ["i-banknot-beyaz", "Hakediş", "Komisyon ödemesi"]].forEach((a, i) => {
  ...
  metin(s, "0" + (i + 1), cx - 1.1, 4.74, { w: 2.2, h: 0.24, boy: 9.5, kalin: true,
    aralik: 2.4, hiza: "center", renk: VURGU });
  metin(s, a[1], cx - 1.1, 5.00, { w: 2.2, h: 0.30, boy: 13.5, kalin: true,
    hiza: "center", renk: GECE });
  metin(s, a[2], cx - 1.1, 5.34, { w: 2.2, h: 0.62, boy: 9.5, hiza: "center", renk: KURSUN });
});
s.addShape(p.ShapeType.rect, { x: M, y: 6.14, w: 11.53, h: 0.92,
  fill: { color: BEYAZ }, line: { color: VURGU, width: 1.25 } });
metin(s, "SUNUMDAN ÖNCE NETLEŞTİRİN", M + 0.30, 6.26, { w: 4.0, h: 0.22, boy: 9,
  kalin: true, aralik: 2.0, renk: VURGU });
metin(s, "Komisyon oranı  ______        Hakediş zamanı  ______        Müşteri koruma süresi  ______",
  M + 0.30, 6.52, { w: 11.0, h: 0.40, boy: 12, renk: GECE });

/* ═══════════════════════════════════ 21 · SATIŞ DESTEK MATERYALLERİ */
s = p.addSlide();
s.background = { color: KAGIT };
etiket(s, "SATIŞ DESTEĞİ", M, 0.86);
baslik(s, "KULLANABİLECEĞİNİZ MATERYALLER\nVE SATIŞ DESTEK EKİPMANLARI", M, 1.10,
  { w: 11.6, h: 1.16, boy: 23 });
cizgi(s, M, 2.32, 1.30, VURGU, 1.5);
...
.forEach((d, i) => {
  const x = M + (i % 2) * 3.55, y = 2.72 + Math.floor(i / 2) * 0.60;
  elmasDolu(s, x + 0.08, y + 0.16, 0.16, VURGU);
  metin(s, d, x + 0.32, y, { w: 3.1, h: 0.34, boy: 12, renk: GECE, dikeyH: "middle" });
});
...
metin(s, "Hepsi baskıya hazır dosya olarak paylaşılır. Bugün en az katalog ve site linki elinizde olsun.",
  M + 0.32, 5.20, { w: 6.5, h: 0.86, boy: 11.5, renk: VURGU_A, dikeyH: "middle" });
...
s = p.addSlide();
s.background = { color: GECE };
s.addImage({ path: fo("gal-01"), x: 0.0, y: 0.0, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-02"), x: 2.683, y: 0.0, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-03"), x: 5.366, y: 0.0, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-04"), x: 8.049, y: 0.0, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-05"), x: 10.732, y: 0.0, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-06"), x: 0.0, y: 3.5, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-07"), x: 2.683, y: 3.5, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-08"), x: 5.366, y: 3.5, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-09"), x: 8.049, y: 3.5, w: 2.603, h: 3.42 });
s.addImage({ path: fo("gal-10"), x: 10.732, y: 3.5, w: 2.603, h: 3.42 });
metin(s, "MİA PARK OCEAN  ·  PROJE GÖRSELLERİ", M, 7.06,
  { w: 6.0, boy: 9, aralik: 2.6, renk: VURGU_A });
metin(s, "Görseller projenin kendi render'larıdır.", W - M - 5.0, 7.06,
  { w: 5.0, boy: 9, aralik: 1.2, hiza: "right", renk: "7E9AAB" });

/* ═══════════════════════════════════ 23 · RAKAMLARLA MİA PARK OCEAN */
s = p.addSlide();
s.background = { color: GECE };
etiket(s, "ÖZET", M, 0.86, VURGU);
baslik(s, "RAKAMLARLA MİA PARK OCEAN", M, 1.22, { w: 10.4, boy: 28, renk: KAGIT });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
...
.forEach((k, i) => {
  ...
  rakam(s, k[0], x + 0.48, y - 0.24, { w: 3.0, h: 0.92, boy: 42, renk: KAGIT });
  metin(s, k[1], x + 0.50, y + 0.76, { w: 3.0, h: 0.26, boy: 10, kalin: true,
...
baslik(s, "NEDEN MİA PARK OCEAN?", M, 1.22, { w: 9.4, boy: 28 });
cizgi(s, M, 2.10, 1.30, VURGU, 1.5);
...
.forEach((o, i) => {
  ...
  metin(s, o[0], x, y + 0.14, { w: 3.5, h: 0.32, boy: 14, kalin: true, renk: GECE });
  metin(s, o[1], x, y + 0.50, { w: 3.5, h: 0.30, boy: 10.5, renk: KURSUN });
});
blok(s, 0, 5.66, W, 1.30, GECE);
metin(s, "DOĞRU KONUM.  DOĞRU ÜRÜN.  GÜÇLÜ SATIŞ HİKÂYESİ.", 0, 5.66,
  { w: W, h: 1.30, boy: 24, kalin: true, hiza: "center", dikeyH: "middle",
    renk: KAGIT, aralik: 1.6 });
metin(s, "MİA PARK OCEAN  ·  İZMİT MİA BÖLGESİ  ·  OCEAN GAYRİMENKUL, TEK YETKİLİ SATICI",
  0, 7.08, { w: W, h: 0.28, boy: 9, aralik: 2.0, hiza: "center", renk: KURSUN });
...
s.addImage({ path: mk("ocean-logo-white.png"), x: 3.95, y: 1.32, w: 1.45, h: 0.60 });
cizgi(s, M, 2.78, 1.30, VURGU, 1.5);
baslik(s, "İZMİT'İN YENİ SATIŞ FIRSATINI\nPORTFÖYÜNÜZE EKLEYİN.", M, 3.02,
  { w: 6.4, h: 1.4, boy: 24, renk: KAGIT });
[["i-telefon-beyaz", "0540 028 00 41  ·  0541 128 40 41"],
 ...
 ["i-insta-beyaz", "@miaparkocean"]].forEach((c, i) => {
  ...
  metin(s, c[1], M + 0.48, y, { w: 5.4, h: 0.36, boy: 12.5, kalin: i === 0,
    renk: KAGIT, dikeyH: "middle" });
});
blok(s, M, 6.62, 3.85, 0.58, VURGU_A);
metin(s, "SATIŞ EKİBİMİZLE İLETİŞİME GEÇİN", M, 6.62, { w: 3.85, h: 0.58, boy: 11,
...
metin(s, "OCEAN GAYRİMENKUL — TEK YETKİLİ SATICI  ·  S.S. YAHYA KAPTAN BİRLİK YAPI KOOPERATİFİ",
  5.05, 7.08, { w: 7.4, h: 0.26, boy: 8.5, aralik: 1.6, hiza: "right", renk: "7E9AAB" });

p.writeFile({ fileName: path.join(KOK, "sunum", "MIA-PARK-OCEAN-Lansman-Sunumu.pptx") })
